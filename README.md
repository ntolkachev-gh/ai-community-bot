...
### Telegram Bot
- `/start` - Расширенная регистрация пользователя с сбором информации:
  - Полное имя
  - Компания и роль
  - Опыт с ИИ (выбор из вариантов)
  - Email для календаря
...
- 📊 **Панель управления** с расширенной статистикой:
  ...
  - Статистика мероприятий и регистраций
- 👥 **Управление пользователями** с детальной информацией:
  - Полное имя, компания, роль
  - Опыт с ИИ
  - Статус завершения профиля
  - Email для календаря
...
| Команда | Описание |
|---------|----------|
| `/start` | Расширенная регистрация с сбором информации о пользователе |
| `/profile` | Просмотр своего профиля |
| `/events` | Просмотр доступных мероприятий |
